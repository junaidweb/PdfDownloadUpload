...
public class FileUpload extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String uploadPath = "C:/Users/JUNAID/eclipse-workspace/PdfUploadDownload/src/main/webapp/AllPdf/" + pdfFileName;
		...
		try {
			...
			PreparedStatement pst = con.prepareStatement("insert into files(filename) values(?)");
